...
class _InputTrainingScreenState extends State<InputTrainingScreen>
        ...
        children: List.generate(
          ...
          (index) => Positioned(
            ...
            child: SlideTransition(
              position: index == memorizedWords.length - 1 && index < memorizedWords.length
                  ? _stackAnimation 
              ...
              child: Container(
                ...
                height: 50,
                decoration: BoxDecoration(
                  color: index < memorizedWords.length 
                      ? AppColors.warning 
                      : AppColors.surface,
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
  ...
  void _handlePanUpdate(DragUpdateDetails details) {
    ...
    setState(() {
      _dragOffset = details.localPosition.dx - 150; // カード幅300の半分
      _dragRotation = _dragOffset * 0.001; // 回転係数
